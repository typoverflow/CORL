...
def train(config: TrainConfig):
    ...
    #     "WandbLogger": {"activate": False, "project": config.project, "entity": config.entity, "config": asdict(config)}
    # }
    ...
    logger = CompositeLogger("./log_transfer", "-".join(["cql", config.env]), loggers_config=loggers_config)
    algos = ["cql"]
    for algo in algos:
